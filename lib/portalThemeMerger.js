    ...
    this.mergeStatic = function(){
        ...
        return new Promise(function(resolve, reject){
            ...
            builder.buildPrototype().done(function(){
                ...
                var mergeConfigPath = that.rt.projectConfigPath; //targetMergeDirPath + path.sep + 'mergeThemeConfigStatic.json';
                console.info("Populating merge configuration (paths to copy) " + mergeConfigPath);
                that.pathsToCopy = that.populateMergePaths(mergeConfigPath, targetMergeDirPath, targetThemeDirPath);
