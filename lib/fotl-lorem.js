...
function PlaceholderFactory(args) {
    ...
    this.readLoremLines = function () {
        ...
        if (this.loremLines.length < 1 || (newModTime > this.lastModTime) && (this.lastModTime - new Date().getTime() > this.checkInterval)) {
