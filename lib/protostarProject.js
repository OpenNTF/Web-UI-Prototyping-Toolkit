...
function Project(args) {
    ...
    this.listAllTemplatePaths = function (dirPath) {
        ...
        htmlFiles.forEach(function (p) {
            ...
            var cc = that.composer.composeTemplate(p, c).content;
        ...
        matches.forEach(function (filePath) {
            ...
            for (var di = 0; di < dropPoints.length; di += 1) {
                ...
                try{
                    ...
                    logger.error("Could not process drop point " + dp.getType()+ ":" + dp.getName());
    ...
    this.updateDynamic = function () {
        ...
        this.runtime.writeFile(this.runtime.constructProjectPath(["_dynamic", "list-referencing-bare.html"]), this.htmlProducer.createBareListingEntriesMarkup(files));
