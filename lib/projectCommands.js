    ...
    var commandFactory = {
        ...
        "load-all-template-pages": function (request, response, project) {
            ...
            /*
             ...
             <iframe class="embed-responsive-item" src="http://localhost:8888/solution.html" ></iframe>
             </div>
             </div>
             */
            var menu = "";
            ...
            files.forEach(function(f){
                ...
                out+=
                '<div class="col-md-12"><h2 id="'+urlPathId+'">'+urlPath+'</h2><a href="#generated-menu">Go to menu</a><div class="embed-responsive embed-responsive-4by3"><iframe class="embed-responsive-item" src="http://localhost:8888'+urlPath+'" ></iframe></div></div>';
            });
