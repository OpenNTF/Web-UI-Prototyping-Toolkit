    ...
    setImmediate(function(){
        if (lessInfo) {
            ...
            if (lessInfo.outputFormat === 'map') {
                ...
                if(rc.wr.containsQueryParam('onlyUsed') && rc.request.headers.hasOwnProperty("referer")){
                    ...
                    if (fs.existsSync(pageFile)) {
                        ...
                        throw new Error("Cannot locate source file for " + pageUrl + " for " + rc.wr.getPathname());
                    }
                    ...
                    rc.project.sslc.handleCompileLessCssUsedOnly(sourceFilePathRef, rc.runtime.readFile(lessInfo.sourceFilePath), locationsProducerFn, [rc.wr.getPathname()], rc.runtime.projectDirPath, rc.response);
                }else{
