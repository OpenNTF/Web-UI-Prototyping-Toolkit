...
var handleRestData = function (rc) {
    ...
    var listPrefix = "list";
    var urlPathname = rc.wr.getPathname();//decodeURIComponent(urlParts.pathname);
    logger.info("REST " + rc.wr.getMethod() + " " + urlPathname + " with query:", rc.wr.getQueryObject());
    var modelPath;
    var fs = require("fs");
    var modelTypePrefix;
    ...
    if (rc.wr.getMethod() === 'POST' && modelTypePrefix === 'object' && rc.wr.containsQueryParam('create') && rc.wr.getQueryParam('create')=== '') {
