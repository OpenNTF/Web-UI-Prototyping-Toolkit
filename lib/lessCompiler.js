...
function createServerSideLessCompiler(basePath, lessParserAdditionalArgs) {
    var sslc = {
        lessParserAdditionalArgs: lessParserAdditionalArgs,
        ...
        handleCompileLessCss: function (filename, file, response) {
            ...
            if (sslc.lessFilePathsBeingCompiled.hasOwnProperty(filename)) {
                ...
                compile(filename, [path.join(filename, "../")], '' + file, basePath, finishedCompilingCss, undefined, sslc.lessParserAdditionalArgs);
            }
        },
