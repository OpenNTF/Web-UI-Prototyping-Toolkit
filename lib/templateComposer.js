...
function TemplateComposer(args) {
    ...
    this.listDropPointTypes = function(){
        var dropPointTypes = [];
    ...
    this.readFragment = function(filePath, metadata) {
        ...
        if(filePath.substring(filePath.lastIndexOf(".")) === ".jade"){
            ...
            fragment = runtime.readFile(filePath);
        }
    ...
    this.renderBackendView = function (request, response, content, viewName, tagArgs) {
        ...
        this.composesToFullHtmlTemplate = function(filePath, fileContents, maxRuns){
           ...
           function isHtml(str){
            ...
            if(typeof fileContents !== 'string'){
                fileContents = runtime.readFile(filePath, 'utf8');
            }
