...
function PlaceholderFactory(args) {
    ...
    this.applyPlaceholder = function (layoutPlaceholder, composed, metadata) {
        ...
        function applyContentPlaceholderWrapper(contentTag, orderedDropPointReplacement) {
            console.log("apply wrapper for tag ", contentTag, " replacing with content=", orderedDropPointReplacement);
            ...
            console.log("CNT WRAP RESULT = ", orderedDropPointReplacement);
        ...
        function replaceLayoutPlaceholderByOrder(layoutTag, composedMarkup, layoutTemplate) {
            ...
            layoutContentDropPoints.forEach(function (currentContentTagDroppoint, dpIdx) {
                ...
                console.log("Processing content droppoint#" + dpIdx + "=", currentContentTagDroppoint.getTag(), " invoked for arguments=", currentLayoutTagArguments);
                ...
                if (utils.isDefined(currentLayoutTagArguments)) {
                    if (currentLayoutTagArguments.indexOf(',') > 0) {
                        ...
                        splitArgs.forEach(function (currentDropPointArg) {
                            ...
                            console.log("REPLACEMENT FOR " + currentDropPointArg + " = " + replacement);
                        ...
                        console.log("REPLACEMENT SINGLE = " + otherReplacement);
                        orderedDropPointReplacement = otherReplacement;

                    }
                }

                layoutTemplate = currentContentTagDroppoint.replacePartContents(layoutTemplate, orderedDropPointReplacement);
        ...
        function replaceLayoutPlaceholderByName(layoutPlaceholderByName, composedMarkup, layoutTemplate) {
            ...
            //by name
            for (var dpIdx = 0; dpIdx < layoutTagContentDropPoints.length; dpIdx += 1) {
                var currentContentTag = layoutTagContentDropPoints[dpIdx];
                var layoutContentDropPoint = currentContentTag;
                    ...
                    specifiedArgs.forEach(function (currentArg) {
                        if (currentArg.indexOf(',') > 0) {
                            ...
                            splitArgs.forEach(function (currentDropPointArg) {
                                ...
                                console.log("REPLACEMENT FOR " + currentDropPointArg.getTag() + " = " + replacement);
