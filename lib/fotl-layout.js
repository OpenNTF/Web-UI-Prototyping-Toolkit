...
function PlaceholderFactory(args) {
    ...
    this.applyPlaceholder = function (layoutPlaceholder, composed, metadata) {
        ...
        function applyContentPlaceholderWrapper(currentDroppoint, orderedDropPointReplacement) {
        ...
        function replaceLayoutPlaceholderByOrder(layoutPlaceholderByOrder, composedMarkup, layoutTemplate) {
            ...
            layoutContentDropPoints.forEach(function (currentDroppoint, dpIdx) {
                ...
                //if(runtime.isDebug()){
                console.log("Processing content droppoint#" + dpIdx + "=", currentDroppoint.getTag(), " with ARGS=", currentDroppointArgs);
                ...
                if (currentDroppoint.hasArgs()) {
                    orderedDropPointReplacement = applyContentPlaceholderWrapper(currentDroppoint, orderedDropPointReplacement);
                }
        ...
        function replaceLayoutPlaceholderByName(layoutPlaceholderByName, composedMarkup, layoutTemplate) {
            ...
            for (var dpIdx = 0; dpIdx < layoutContentDropPoints.length; dpIdx += 1) {
                ...
                var layoutContentDropPoint = currentDropPoint;
                ...
                if (currentDropPoint.hasArgs()) {
                    namedDropPointReplacement = applyContentPlaceholderWrapper(currentDropPoint, namedDropPointReplacement);
                }
