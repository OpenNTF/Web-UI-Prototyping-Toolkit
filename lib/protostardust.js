...
ProtoStarServer.prototype.startServer = function() {
    ...
    function startListening(){
        ...
        t.server.on("listening", function () {
            ...
            logger.info("protostar started up in " + (new Date().getTime() - t.runtime.launchTime) + "ms");
            logger.info("protostar is listening on http://localhost:" + t.runtime.getPort() + "/");
...
ProtoStarServer.prototype.createServer = function() {
    ...
    t.project.sslc = this.sslc;
    //t.project.htmlProducer = htmlProducer.createHtmlProducer({
    //    runtime: t.runtime
    //});
    this.handlers = {};
            ...
            hf(request, response).done(function(handlerName){
                ...
                try{
                    ...
                    if(t.runtime.lenient){
                        //logger.error("Error handling request for " + request.method + " " + request.url + " with handler " + handlerName + ": "+ he.message);
