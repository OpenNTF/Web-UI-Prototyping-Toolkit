...
module.exports.label = 'Responsive Screenshots for All Pages';
module.exports.description = 'Generates screenshots for different screen factors for all pages to a directory /screenshots below the project directory';