...
module.exports=function (rc) {
    ...
    portalTooling.isPortalRunning(host, port, urlPathname, function(isRunning){
        if(isRunning){
            ...
            portalTooling.prepareScriptPortletPush(dirPath, rc.project, function(err, tmpDir){
                if(err){
                    ...
                    portalTooling.pushScriptPortletFromDir(tmpDir, rc.project, function(error, dirPath, stdout, stderr, logFileContents){
