...
function ProtostarRuntime(args){
    ...
    if(!utils.isArray(args.fullCommandLineArgs) || args.fullCommandLineArgs.length < 2){
     ...
     * @type {String}
     */
    this.nodeCommandPath = args.nodeCommandPath;
    logger.info("node path = " + this.nodeCommandPath);

    /**
     * @type {String}
     */
    this.protostarScriptPath = args.protostarScriptPath;
    logger.info("protostar script path = " + this.protostarScriptPath);
    /**
     * @type {String}
     */
    this.protostarDirPath  = args.protostarDirPath;
    if(typeof args.protostarDirPath !== 'string') throw new Error("missing protostarDirPath");
    /**
     * @type {String}
     */
...
//
//ProtostarRuntime.prototype.parseCommandLineArgs = function(){
...
//        case 'mergeStatic':
//
//            this.mode = "mergeStatic";
//            this.projectDirPath = utils.normalizePathCmdLine(cmdArgs[1]);
//            //this.themeDirPath = utils.normalizePathCmdLine(cmdArgs[2]);
//            this.targetDirPath = utils.normalizePathCmdLine(cmdArgs[2]);
//            console.log("MERGE STATIC MODE ENABLED project="+this.projectDirPath + " targetDir="+this.targetDirPath);
//            break;
//        case 'merge':
//            this.mode = "merge";
//            this.projectDirPath = utils.normalizePathCmdLine(cmdArgs[1]);
//            this.themeDirPath = utils.normalizePathCmdLine(cmdArgs[2]);
//            this.targetDirPath = utils.normalizePathCmdLine(cmdArgs[3]);
//            console.log("MERGE MODE ENABLED project="+this.projectDirPath + " theme="+this.themeDirPath + " targetDir="+this.targetDirPath);
//            break;
//        default:
//            // old way of invoking
//            if(argCount === 3){
 ...
 * @return {boolean}
 */
ProtostarRuntime.prototype.isStrict = function(){
    return this.strict;
};
