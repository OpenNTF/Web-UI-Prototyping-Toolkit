...
//                throw new Error("Uknown command: " + firstArg);
    ...
    this.getThemeDirPath = function(){
        return this.themeDirPath;
    };
    this.getProjectDirPath = function(){
        return this.themeDirPath;
    };
    ...
    this.findFileForUrlPathname = function (upn) {
        var filePath = false;
    ...
    this.resolveExactFilePathForPlaceHolder = function(placeholder){
