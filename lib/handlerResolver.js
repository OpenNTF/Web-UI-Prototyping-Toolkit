                ...
                case 'GET':
                    ...
                    if (isCommandRequest(urlParts)) {
                        ...
                        fs.stat(requestedFilePath).done(function(stat){
                            ...
                            var handlerNameGET = false;
                            logger.info("Requested file path does not exist " + requestedFilePath);
                            ...
                            if(urlPathExtname === '.html' || !urlPathExtname){
                                ...
                                //    interceptLessCssRequestParameters(request, response);
                                //    handlerNameGET = "handleViewCompiledJadeTemplate";
                                //}else{
                                //    handlerNameGET = "handleCantResolveNonExistingFileRequest";
                                //}
                            }else{
                                var lessFp = runtime.findFileForUrlPathname(urlPathname.substring(0, urlPathname.lastIndexOf('.')) + ".less");
                                console.log("lessfp = " + lessFp);
                                var scssFp = runtime.findFileForUrlPathname(urlPathname.substring(0, urlPathname.lastIndexOf('.')) + ".scss");
                                console.log("scssfp = " + scssFp);
